...
with col_graph:
    ...
    # بيانات استرشادية لأهم أحياء الرياض في 2026
    data = {
...
with col_dl1:
    ...
    # ملاحظة: قم بوضع ملفات الـ PDF الفعلية في نفس مجلد كود المشروع ليتمكن التطبيق من قراءتها
    try:
        ...
        st.warning("يرجى رفع ملف 'SAMA_May_2026.pdf' إلى الخادم لتفعيل زر التحميل المباشر.")
...
with col_dl2:
    ...
    try:
        ...
        st.warning("يرجى رفع ملف 'GASTAT_Q1_2026.pdf' إلى الخادم لتفعيل زر التحميل المباشر.")
