...
# تعديل اتجاه الواجهة لتكون من اليمين إلى اليسار بطريقة متوافقة مع بايثون 3.14
st.markdown("<style>div.stApp { direction: RTL; text-align: right; }</style>", unsafe_allow_headers=True)
...
* **العائد المالي الفوري (الشقق):** تعد أحياء مثل **الياسمين، قرطبة، والملقا** هي الحاضنة المثالية للاستثمار السكني المدر للدخل، حيث يقارب العائد الإيجاري للشقق الذكية المؤثثة ما بين **7.5% إلى 8.5%** نتيجة الطلب المرتفع من الشركات الكبرى والموظفين.
""")
